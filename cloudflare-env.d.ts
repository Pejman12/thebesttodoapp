/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 7f87ca31e3a2da2e72b0e3dd32ef62dd)
// Runtime types generated with workerd@1.20250902.0 2025-09-07 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: "pk_test_dGVuZGVyLWJlZGJ1Zy0zNi5jbGVyay5hY2NvdW50cy5kZXYk";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "NEXT_PUBLIC_CLERK_API_KEY" | "NEXTJS_ENV" | "CLERK_SECRET_KEY" | "DATABASE_URL">> {}
}
